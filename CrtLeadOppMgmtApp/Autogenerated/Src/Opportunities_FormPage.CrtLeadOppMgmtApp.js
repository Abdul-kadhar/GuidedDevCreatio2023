		...
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_w68dt2t_SelectedRows",
					"_filterOptions": {
						"from": [
							"ContactRolesList",
							"GridDetail_w68dt2t_SelectedRows"
						],
						"expose": []
					},
					"visible": true,
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_b6usef9_SelectedRows",
					"_filterOptions": {
						"from": [
							"OpportunityTeamList",
							"GridDetail_b6usef9_SelectedRows"
						],
						"expose": []
					},
					"visible": true,
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_68n2t8d_SelectedRows",
					"_filterOptions": {
						"from": [
							"CompetitorsList",
							"GridDetail_68n2t8d_SelectedRows"
						],
						"expose": []
					},
					"visible": true,
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$DataGrid_a2xhxnu_SelectedRows",
					"_filterOptions": {
						"expose": [],
						"from": [
							"DataGrid_a2xhxnu",
							"DataGrid_a2xhxnu_SelectedRows"
						]
					},
					"visible": false,
					"features": {
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_dm9992m_SelectedRows",
					"_filterOptions": {
						"from": [
							"ProductsList",
							"GridDetail_dm9992m_SelectedRows"
						],
						"expose": []
					},
					"visible": true,
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_n5ochpc_SelectedRows",
					"_filterOptions": {
						"from": [
							"RecommendedProductList",
							"GridDetail_n5ochpc_SelectedRows"
						],
						"expose": []
					},
					"features": {
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_rnogu7n_SelectedRows",
					"_filterOptions": {
						"expose": [],
						"from": [
							"GridDetail_rnogu7n",
							"GridDetail_rnogu7n_SelectedRows"
						]
					},
					"features": {
						"editable": {
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_n4l8edn_SelectedRows",
					"_filterOptions": {
						"expose": [],
						"from": [
							"GridDetail_n4l8edn",
							"GridDetail_n4l8edn_SelectedRows"
						]
					},
					"visible": true,
					"features": {
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_iwda2md_SelectedRows",
					"_filterOptions": {
						"expose": [],
						"from": [
							"GridDetail_iwda2md",
							"GridDetail_iwda2md_SelectedRows"
						]
					},
					"visible": true,
					"features": {
					...
					"columns": [
						...
						{
							"id": "43075a0a-887d-5a0b-983a-876acb29a07b",
							"code": "OpportunitiesByCustomerListDS_PredictiveProbability",
							"path": "PredictiveProbability",
							"caption": "#ResourceString(OpportunitiesByCustomerListDS_PredictiveProbability)#",
							"dataValueType": 4,
							"width": 130
						},
						{
				...
				"GridDetail_iwda2md": {
					...
					"viewModelConfig": {
						"attributes": {
							...
							"OpportunitiesByCustomerListDS_PredictiveProbability": {
								"modelConfig": {
									"path": "OpportunitiesByCustomerListDS.PredictiveProbability"
								}
							},
