		...
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"_filterOptions": {
						"from": [
							"SimilarLeadList",
							"GridDetail_p7secbz_SelectedRows"
						],
						"expose": []
					},
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_xvhalua_SelectedRows",
					"_filterOptions": {
						"from": [
							"ProductsList",
							"GridDetail_xvhalua_SelectedRows"
						],
						"expose": []
					},
					"items": "$ProductsList",
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_q6k1kvr_SelectedRows",
					"_filterOptions": {
						"expose": [],
						"from": [
							"GridDetail_q6k1kvr",
							"GridDetail_q6k1kvr_SelectedRows"
						]
					},
					"features": {
						"editable": {
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_yoxos8p_SelectedRows",
					"_filterOptions": {
						"expose": [],
						"from": [
							"GridDetail_yoxos8p",
							"GridDetail_yoxos8p_SelectedRows"
						]
					},
					"features": {
						"editable": {
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_qiohu6o_SelectedRows",
					"_filterOptions": {
						"expose": [],
						"from": [
							"GridDetail_qiohu6o",
							"GridDetail_qiohu6o_SelectedRows"
						]
					},
					"visible": true,
					"fitContent": true,
					...
					"columns": [
						...
						{
							"id": "1d024843-0681-4f2b-479f-d514b9643e4d",
