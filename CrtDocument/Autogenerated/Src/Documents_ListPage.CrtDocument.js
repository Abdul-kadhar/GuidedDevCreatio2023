		...
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"config": {
						"caption": "#ResourceString(QuickFilter_vf75lps_config_caption)#",
						"hint": "",
						"icon": "date",
			...
			},
			{
				...
				"values": {
					"type": "crt.QuickFilter",
					"config": {
						"caption": "#ResourceString(QuickFilter_oeeusfi_config_caption)#",
						"hint": "",
			...
			},
			{
				...
				"values": {
					"type": "crt.QuickFilter",
					"config": {
						"caption": "#ResourceString(QuickFilter_hzyk871_config_caption)#",
						"hint": "",
