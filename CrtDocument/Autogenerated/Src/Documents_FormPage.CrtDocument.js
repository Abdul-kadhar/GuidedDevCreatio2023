define("Documents_FormPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			{
				"operation": "insert",
				"name": "addRecord_08to32w",
				"values": {
					"code": "addRecord",
					"type": "crt.ComboboxSearchTextAction",
					"icon": "combobox-add-new",
					"caption": "#ResourceString(addRecord_08to32w_caption)#",
					"clicked": {
			...
			{
				"operation": "insert",
				"name": "addRecord_1v2ydu1",
				"values": {
					"code": "addRecord",
					"type": "crt.ComboboxSearchTextAction",
					"icon": "combobox-add-new",
					"caption": "#ResourceString(addRecord_1v2ydu1_caption)#",
					"clicked": {
						"request": "crt.CreateRecordFromLookupRequest",
						"params": {}
					}
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_h7omalt_SelectedRows",
					"selectionState": "$GridDetail_h7omalt_SelectionState",
					"_filterOptions": {
						"from": [
							"GridDetail_h7omalt",
							"GridDetail_h7omalt_SelectedRows"
						],
						"expose": []
					},
					"_selectionOptions": {
						"attribute": "GridDetail_h7omalt_SelectionState"
					},
