		...
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			{
				...
				"values": {
					"_filterOptions": {
						"from": [
							"AddressList",
							"AddressList_SelectedRows"
						],
						"expose": []
					},
					"selectionState": "$AddressList_SelectionState",
					"_selectionOptions": {
						"attribute": "AddressList_SelectionState"
					}
				}
			},
			{
			...
			},
			{
				...
				"values": {
					"_filterOptions": {
						"from": [
							"ContactsList",
							"ContactsList_SelectedRows"
						],
						"expose": []
					},
					"selectionState": "$ContactsList_SelectionState",
					"_selectionOptions": {
						"attribute": "ContactsList_SelectionState"
					}
				}
			},
			{
			...
			},
			{
				...
				"values": {
					...
					"_filterOptions": {
						"from": [
							"DocumentList",
							"DocumentList_SelectedRows"
						],
						"expose": []
					},
					"selectionState": "$DocumentList_SelectionState",
					"_selectionOptions": {
						"attribute": "DocumentList_SelectionState"
					}
				}
			},
			{
			...
			},
			{
				...
				"values": {
					...
					"selectedRows": "$GridDetail_qpp45xn_SelectedRows",
					"selectionState": "$GridDetail_qpp45xn_SelectionState",
					"_filterOptions": {
						"from": [
							"GridDetail_qpp45xn",
							"GridDetail_qpp45xn_SelectedRows"
						],
						"expose": []
					},
					"_selectionOptions": {
						"attribute": "GridDetail_qpp45xn_SelectionState"
					},
					"visible": true,
					"fitContent": true,
			...
			},
			{
				...
				"values": {
					...
					"_filterOptions": {
						"from": [
							"ContractList",
							"ContractList_SelectedRows"
						],
						"expose": []
					},
					"selectionState": "$ContractList_SelectionState",
					"_selectionOptions": {
						"attribute": "ContractList_SelectionState"
					}
				},
